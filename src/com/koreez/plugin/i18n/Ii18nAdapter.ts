...
export interface Ii18nAdapter {
    ...
    exists(key: string | string[], options?: i18next.TranslationOptions<object>): boolean;
     ...
     */
    getFixedT(lng: string | string[], ns?: string | string[]): i18next.TranslationFunction<any, object, string>;
